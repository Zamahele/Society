...
public class PaymentsControllerTests
{
    ...
    private sealed class TrackingPaymentService : IPaymentService
    {
        ...
        public Task<JoiningFeePayment> SubmitJoiningFeeAsync(int membershipId, string reference, DateTime paymentDate, string? submittedByClerkId = null, byte[]? proofData = null, string? proofFileName = null) => throw new NotImplementedException();
        ...
        public Task<MonthlyPayment> SubmitMonthlyPaymentAsync(int membershipId, DateTime forMonth, string reference, DateTime paymentDate, string? submittedByClerkId = null, byte[]? proofData = null, string? proofFileName = null) => throw new NotImplementedException();
